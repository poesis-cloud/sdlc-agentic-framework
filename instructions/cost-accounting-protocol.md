...
> Companion of the [GitHub sync protocol](../sync/github/github-sync-protocol.md): same house style, same
...
> `has(unit.cost)` postcondition cannot see. This protocol stays the rationale source those bound
