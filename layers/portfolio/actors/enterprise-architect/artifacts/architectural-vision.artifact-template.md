...
backbone, and the architectural-runway direction. Authored by `@enterprise-architect` in the
...
## NFR backbone
Cross-product nonfunctional requirements (→ each product's `architecture/nfrs.md`).
