...
toward. Sourced from `gsm/GSM-PUBLICATION-STRATEGY.md` and the two business lines.

```markdown
---
owner: central-supervisor      # Business-Owner hat
updated: YYYY-MM-DD
source: gsm/GSM-PUBLICATION-STRATEGY.md
---
...
- **Linked Epics:** E-NN, E-NN (Epics that advance this theme).
